...
knitr::opts_knit$set(root.dir = '/Users/eilishmcmaster/Documents/HakeSeri')
```
...
species <- "HakeSeri" #species name
dataset <- "DHak19-4512" #dart order
missingness <- 0.3
# keyspecies <- "fragrans"
# outgroup <- "milesiae"
```
